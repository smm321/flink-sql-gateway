 ...
 */
public class HdfsFilePathParameter extends MessagePathParameter<String> {

    public static final String KEY = "path";

    public HdfsFilePathParameter() {
        super(KEY);
    }
    ...
    protected String convertFromString(String value) throws ConversionException {
        try {
            ...
            throw new ConversionException("Not a valid hdfs file path: " + value, iae);
        }
    }
