...
public class YarnJobInfoResponseBody implements ResponseBody {
    ...
    private List<YarnJobInfoResult> data;

    public YarnJobInfoResponseBody(@JsonProperty(FIELD_NAME_RRR_MSG) String errMsg,
                                   @JsonProperty(FIELD_NAME_DATA) List<YarnJobInfoResult> data) {
        this.errMsg = errMsg;
        this.data = data;
    }
}
