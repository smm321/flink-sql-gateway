...
/**
 * Message headers for lunch flink yarn session.
 */
public class YarnSessionHeaders
        implements MessageHeaders<YarnJobSubmitRequestBody, YarnJobSubmitResponseBody, EmptyMessageParameters> {

    private static final YarnSessionHeaders INSTANCE = new YarnSessionHeaders();

    public static final String URL = "/job/session";

    private YarnSessionHeaders() {
    }
    ...
    public String getDescription() {
        return "Lunch a flink-session on yarn.";
    }
    ...
    public static YarnSessionHeaders getInstance() {
        return INSTANCE;
    }
