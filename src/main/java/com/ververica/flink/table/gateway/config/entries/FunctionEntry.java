...
public class FunctionEntry extends ConfigEntry {
    ...
    private FunctionEntry(String name, Configuration properties) {
        super(properties);
        this.name = name;
    }
...
//    }
    ...
    private static FunctionEntry create(Configuration properties) {
        ...
        validater.validateString(FUNCTIONS_NAME, false, 1);
        final String name = validater.getString(FUNCTIONS_NAME);
        final Configuration cleanedProperties =
                validater.withoutKeys(Collections.singletonList(FUNCTIONS_NAME));
