...
public class YarnJobSubmitResponseBody implements ResponseBody {
    ...
    public YarnJobSubmitResponseBody(@JsonProperty(FIELD_NAME_RRR_MSG) String errMsg,
                                     @JsonProperty(FIELD_NAME_APPLICATION_ID) String applicationId) {
        this.errMsg = errMsg;
